...
const { saleEventTypes, calculateType, UPDATE_PROFILE_EVENT_CODE } = require('../../constants');
    ...
    const events = [
      {
        ...
        title: 'Tặng 200k cho người dùng cập nhật đầy đủ thông tin cá nhân',
        image: 'events/event-1.png',
        from: dayjs(),
        to: dayjs().add(240, 'month'),
